...
<?PHP
include "../core/reclamC.php";
$reclam1C=new reclamC();
$listereclam=$reclam1C-> afficherReclam();
                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user-menu">
                    <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                      <img src="C:\wamp64\www\electro\reclam\views\arwaimge.JPG" class="user-image" alt="User Image" />
                      <span class="d-none d-lg-inline-block">Arwa bejaoui</span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-right">
                      <!-- User image -->
                      <li class="dropdown-header">
                        <img src="C:\wamp64\www\electro\reclam\views\arwaimge.JPG" class="img-circle" alt="User Image" />
                        <div class="d-inline-block">
                          Arwa Bejaoui <small class="pt-1">arwa.bejaoui@esprit.tn</small>
                        </div>
                      </li>
                      ...
                      <table class="table card-table table-responsive table-responsive-large" style="width:100%">
                        <thead>
                          <tr>
                            ...
                            <th class="d-none d-md-table-cell">Libelle produit</th>
                            <th>Sujet</th>
                            <th>Etat</th>
                          ...
                          ?>
                          <tr>
                              <th><?PHP echo $row['idreclam']; ?></th>
                              <th><?PHP echo $row['email']; ?></th>
                              <th><?PHP echo $row['first_name']; ?></th>
                              <th><?PHP echo $row['last_name']; ?></th>
                              <th><?PHP echo $row['libprod']; ?></th>
                              <th><?PHP echo $row['sujet']; ?></th>
                              <th><?PHP echo $row['etat']; ?></th>
                              <th><?PHP echo $row['daterelam']; ?></th>
                          </tr>
