						...
						<div class="billing-details">
							...
							<form method="post" action="check.php">
								...
								<label>pays</label>
									...
									<div class="input-group">
									  <label>mobile</label>
									  <input type="int" name="mobile" value="<?php echo $mobile; ?>">
									</div>
										...
										<form action="checksav.php" method="post" name="myform">
											...
											<div class="input-group">
												...
												<div class="input-group">
												  ...
												  <input type="text" name="libprod" value="<?php echo $code_postal; ?>">
												</div>
												<div class="input-group">
													<label>pays</label>
													<input type="text" name="pays" value="<?php echo $pays; ?>">
												  ...
												  <div class="input-group">
													<label>adresse</label>
													<input type="text" name="adress1" value="<?php echo $adress; ?>">
												  </div>
