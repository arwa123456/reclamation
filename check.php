...
//insert fi base de donne 3la ases utilisateur jdid
  	$query = "INSERT INTO user_info (first_name, last_name , email,password ,code_postal, mobile,ville,pays,adress1  ) 
  			  VALUES('$firstname','$lastname', '$email','$password','$codepostal','$mobile','$pays','$ville','$adresse')";
